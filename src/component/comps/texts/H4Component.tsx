...
export default class H4Component extends AbstractComponent {
  constructor(name?: string, desc?: string) {
    super(name ? name : "H4", desc ? desc : "Heading 4", "h4");
  ...
  clone(): AbstractComponent {
    return new H4Component(createRandomId(), createRandomId());
  }
}
